package edu.project.TouristTicketOrder.BottomNavFragment.ManageFragment;
...
import edu.project.TouristTicketOrder.Admin_Activity.CTHD.CTHD_List_Adapter;
...
public class ManageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv_cthd = (ListView) view.findViewById(R.id.lv_cthd);
    ...
    {
        CTHD_List_Adapter CTHD_List_Adapter = new CTHD_List_Adapter(requireContext(), dataBaseHandler.getAllCTHD(maKH, tenTuyen, ""));
